! function(e, t) {
    ...
    function e(e) {
        if (e in z) return e;
        for (var t = e[0].toUpperCase() + e.slice(1), n = W.length; n--;)
            if (e = W[n] + t, e in z) return e
    }
    ...
    function c() {
        ...
        }), r(a.elements.preview, "cr-image"), r(i, "cr-overlay"), a.element.appendChild(e), e.appendChild(a.elements.preview), e.appendChild(n), e.appendChild(i), r(a.element, s), a.options.customClass && r(a.element, a.options.customClass), g.call(this), a.options.enableZoom && m.call(a)
    }
    ...
    function p(e) {
        this.options.enableZoom && (this.elements.zoomer.value = X(e, 4))
    }
    ...
    function m() {
        function e() {
            d.call(n, {
                ...
                transform: N.parse(n.elements.preview)
            })
        }

        function t(t) {
            var i, o;
            i = t.wheelDelta ? t.wheelDelta / 1200 : t.deltaY ? t.deltaY / 1060 : t.detail ? t.detail / -60 : 0, o = n._currentZoom + i, t.preventDefault(), p.call(n, o), e()
        }
        var n = this,
            i = n.elements.zoomerWrap = document.createElement("div"),
            o = n.elements.zoomer = document.createElement("input");
        r(i, "cr-slider-wrap"), r(o, "cr-slider"), o.type = "range", o.step = "0.005", o.value = 1, o.style.display = n.options.showZoomer ? "" : "none", n.element.appendChild(i), i.appendChild(o), n._currentZoom = 1, n.elements.zoomer.addEventListener("input", e), n.elements.zoomer.addEventListener("change", e), n.options.mouseWheelZoom && (n.elements.boundary.addEventListener("mousewheel", t), n.elements.boundary.addEventListener("DOMMouseScroll", t))
    }

    function d(e) {
        var t = this,
            n = e ? e.transform : N.parse(t.elements.preview),
            i = e ? e.viewportRect : t.elements.viewport.getBoundingClientRect(),
            r = e ? e.origin : new D(t.elements.preview);
        if (t._currentZoom = e ? e.value : t._currentZoom, n.scale = t._currentZoom, t.options.enforceBoundary) {
            var a = f.call(t, i),
                s = a.translate,
                l = a.origin;
            n.x >= s.maxX && (r.x = l.minX, n.x = s.maxX), n.x <= s.minX && (r.x = l.maxX, n.x = s.minX), n.y >= s.maxY && (r.y = l.minY, n.y = s.maxY), n.y <= s.minY && (r.y = l.maxY, n.y = s.minY)
        }
        var u = {};
        u[P] = n.toString(), u[S] = r.toString(), o(t.elements.preview, u), H.call(t), y.call(t)
    }
    ...
    function v() {
        var e = this,
            ...
            r = N.parse(e.elements.preview.style[P]),
        ...
        var h = {};
        h[S] = u.x + "px " + u.y + "px", h[P] = r.toString(), o(e.elements.preview, h)
    }

    function g() {
        function e(e) {
            if (e.preventDefault(), !c) {
                if (c = !0, r = e.pageX, a = e.pageY, e.touches) {
                    var i = e.touches[0];
                    r = i.pageX, a = i.pageY
                }
                transform = N.parse(u.elements.preview), window.addEventListener("mousemove", t), window.addEventListener("touchmove", t), window.addEventListener("mouseup", n), window.addEventListener("touchend", n), document.body.style[O] = "none", l = u.elements.viewport.getBoundingClientRect()
            }
        }
        ...
        function t(e) {
            ...
            var h = t - r,
                m = n - a,
                d = u.elements.preview.getBoundingClientRect(),
                f = transform.y + m,
                v = transform.x + h,
                g = {};
            if ("touchmove" == e.type && e.touches.length > 1) {
                var y = e.touches[0],
                    x = e.touches[1],
                    b = Math.sqrt((y.pageX - x.pageX) * (y.pageX - x.pageX) + (y.pageY - x.pageY) * (y.pageY - x.pageY));
                s || (s = b / u._currentZoom);
                var C = b / s;
                return p.call(u, C), void i(u.elements.zoomer)
            }
            u.options.enforceBoundary ? (l.top > d.top + m && l.bottom < d.bottom + m && (transform.y = f), l.left > d.left + h && l.right < d.right + h && (transform.x = v)) : (transform.y = f, transform.x = v), g[P] = transform.toString(), o(u.elements.preview, g), w.call(u), a = n, r = t
        }

        function n() {
            c = !1, window.removeEventListener("mousemove", t), window.removeEventListener("touchmove", t), window.removeEventListener("mouseup", n), window.removeEventListener("touchend", n), document.body.style[O] = "", v.call(u), y.call(u), s = 0
        }
        var r, a, s, l, u = this,
            c = !1;
        u.elements.overlay.addEventListener("mousedown", e), u.elements.overlay.addEventListener("touchstart", e)
    }
    ...
    function y() {
        var e = this;
        x.call(e) && e.options.update.call(e, e.get())
    }
    ...
    function C(e) {
        ...
        var t = this,
            ...
            h = -1 * e[0] + a.left,
            m = {};
        m[S] = u + "px " + l + "px", m[P] = new N(h, c, s).toString(), o(t.elements.preview, m), p.call(t, s), t._currentZoom = s
    }
    ...
    function R(e, t) {
        var n = t.points,
            ...
            c = r,
            h = a;
        return t.outputWidth && t.outputHeight && (c = t.outputWidth, h = t.outputHeight), l.width = c, l.height = h, u.drawImage(e, i, o, r, a, 0, 0, c, h), s && (u.fillStyle = "#fff", u.globalCompositeOperation = "destination-in", u.beginPath(), u.arc(c / 2, h / 2, c / 2, 0, 2 * Math.PI, !0), u.closePath(), u.fill()), l.toDataURL(t.format, t.quality)
    }
    ...
    function B(e, t) {
        ...
        if ("string" == typeof e) n = e, e = {};
            ...
            if ("undefined" == typeof e && i.data.url) return b.call(i), y.call(i), null;
            n = e.url, o = e.points || []
        }
        i.data.bound = !1, i.data.url = n || i.data.url, i.data.points = (o || i.data.points).map(function(e) {
            return parseFloat(e)
        });
        var r = s(n, i.elements.img);
        return r.then(function() {
            i.options.useCanvas && (i.elements.img.exifdata = null, _.call(i, e.orientation || 1)), b.call(i), y.call(i), t && t()
        }), r
    }
    ...
    function L(e) {
        var n, i = this,
            ...
            l = r.format,
            u = r.quality,
            c = i.elements.viewport.getBoundingClientRect(),
            h = c.width / c.height;
        return "viewport" === s ? (o.outputWidth = c.width, o.outputHeight = c.height) : "object" == typeof s && (s.width && s.height ? (o.outputWidth = s.width, o.outputHeight = s.height) : s.width ? (o.outputWidth = s.width, o.outputHeight = s.width / h) : s.height && (o.outputWidth = s.height * h, o.outputHeight = s.height)), q.indexOf(l) > -1 && (o.format = "image/" + l, o.quality = u), o.circle = "circle" === i.options.viewport.type, o.url = i.data.url, n = new Promise(function(e) {
            e("canvas" === a ? R.call(i, i.elements.preview, o) : I.call(i, o))
        })
    }
    ...
    function j(e) {
        ...
        r.drawImage(n, 0, 0), (90 === e || -270 === e) && (o = 6), (-90 === e || 270 === e) && (o = 8), (180 === e || -180 === e) && (o = 3), u(n, i, o), d.call(t)
    }
    ...
    function M(e, n) {
        if (this.element = e, this.options = t(t({}, M.defaults), n), c.call(this), this.options.url) {
            var i = {
                url: this.options.url,
                points: this.options.points
            };
            delete this.options.url, delete this.options.points, B.call(this, i)
        }
    }
    ...
    var S, P, O, W = ["Webkit", "Moz", "ms"],
        z = document.createElement("div").style;
    P = e("transform"), S = e("transformOrigin"), O = e("userSelect");
    var T = "translate3d",
        A = ", 0px",
        N = function(e, t, n) {
    ...
    N.parse = function(e) {
        return e.style ? N.parse(e.style[P]) : e.indexOf("matrix") > -1 || e.indexOf("none") > -1 ? N.fromMatrix(e) : N.fromString(e)
    }, N.fromMatrix = function(e) {
        var t = e.substring(7).split(",");
        return t.length && "none" !== e || (t = [1, 0, 0, 1, 0, 0]), new N(parseInt(t[4], 10), parseInt(t[5], 10), parseFloat(t[0]))
    }, N.fromString = function(e) {
        var t = e.split(") "),
            n = t[0].substring(T.length + 1).split(","),
            i = t.length > 1 ? t[1].substring(6) : 1,
            o = n.length > 1 ? n[0] : 0,
            r = n.length > 1 ? n[1] : 0;
        return new N(o, r, i)
    }, N.prototype.toString = function() {
        return T + "(" + this.x + "px, " + this.y + "px" + A + ") scale(" + this.scale + ")"
    };
    var D = function(e) {
    ...
    M.defaults = {
        ...
        setZoom: function(e) {
            p.call(this, e), i(this.elements.zoomer)
        },
        rotate: function(e) {
            j.call(this, e)
        },
    ...
    }), exports.Croppie = window.Croppie = M, "object" == typeof module && module.exports && (module.exports = M)
});
